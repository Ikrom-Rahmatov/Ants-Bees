    ...
    def nearest_bee(self):
        ...
        while True:
            if self.prospective_bees_place.bees == []:
                if self.prospective_bees_place.entrance.is_hive:
                    return None
                else:
                ...
                if self.min_range <= self.distance <= self.max_range:
                    return random_bee(self.prospective_bees_place.bees)
                else:
                    if self.prospective_bees_place.entrance.is_hive:
                        return None
                    else:
...
class HungryAnt(Ant):
    ...
    def eat_bee(self, bee):
        bee_to_remove = random_bee(self.place.bees)
        if bee_to_remove != None:
            bee_to_remove.reduce_health(bee_to_remove.health)
...
class ContainerAnt(Ant):
    ...
    def can_contain(self, other):
        # BEGIN Problem 8
        if other.is_container and self.ant_contained:
            return False
        else:
            return True
        # END Problem 8
